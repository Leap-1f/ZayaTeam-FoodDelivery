...
import { EmailIcon, PhoneNumberIcon } from "../icons/iconSvg";
...
export const UserProfile = () => {
  ...
  return (
    <Box sx={{width: "100%", display: 'flex', justifyContent: 'center', marginY: '100px', border: 'solid', borderWidth: '1px', borderColor: 'white'}}>
      <Box
        sx={{
          width: "432px",
          display: "flex",
          ...
          >
            ...
            >
              ...
              >
                ...
                <Typography component="h3">88883345</Typography>
              </Box>
              <Box>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            >
              ...
              >
                <Typography>И-мэйл хаяг</Typography>
                <Typography component="h3">Ugtakhbayar@gmail.com</Typography>
              </Box>
              <Box>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
