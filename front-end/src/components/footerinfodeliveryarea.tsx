    ...
    return (
        <Box sx={{width: '100%',display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
            <Box sx={{width: '60%%', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '40px'}}>
                <DeliveryAreaMap />
                <Box sx={{display: 'flex', justifyContent: 'flex-start', width: '100%', gap: '15px' }}>
                    <StarIcon />
                    <Typography>Хүргэлтийн бүс дэх хаягууд</Typography>
                </Box>
                <Box sx={{display: 'flex', justifyItems: 'space-between', width: '100$'}}>
                    <Box  sx={{width: '500px', padding: '20px'}}>
                        <Typography sx={{}}>А бүс</Typography>
                        <Box sx={{width: '100%', borderBottom: 'solid', borderWidth: '1px', borderColor: '#18BA51', marginY: '15px'}}></Box>
