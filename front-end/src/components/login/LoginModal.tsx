...
export default function LogInModal() {
    return (
        <>
            <Box sx={{ width: "450px", height: "550px", padding: "32px", display: "flex", gap: "48px", borderRadius:"16px" }} flexDirection={"column"}  >
                <Typography sx={{ textAlign: "center" }} variant="h5">Нэвтрэх</Typography>
                <Box sx={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                    <Box sx={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                        <Typography variant="h6" >Имэйл</Typography>
                        <TextField sx={{ width: "100%", backgroundColor: "#F7F7F8" }} id="outlined-basic" label="Имэйл хаягаа оруулна уу  " ></TextField>
                    </Box>
                    <Box sx={{ display: "flex", flexDirection: "column", gap: "4px" }}>
