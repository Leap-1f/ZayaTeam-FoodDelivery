      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Search sx={{ border: 'solid', borderRadius: '8px', borderColor: '#000000', marginRight: '30px'}}>
            ...
            <StyledInputBase
              placeholder="Хайх" sx={{color: '#000000', width: '180px', marginLeft: '40px'}}
              inputProps={{ 'aria-label': 'search' }}
            />
          </Search>
          <Box sx={{display: 'flex', gap: '40px'}}>
            <Box sx={{color: "#000000", fontFamily: "sans-serif", display: 'flex', alignItems: 'center', gap:'10px', cursor: 'pointer'}}>   
                  <HeaderBucketIcon/>
                  Сагс
            </Box>
            <Box sx={{color: "#000000", fontFamily: "sans-serif", display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer'}}>            
